...
import com.hgm.haritagenelmudurlugu.Pages.BilimActivity;
import com.hgm.haritagenelmudurlugu.Pages.DergiArsivActivity;
import com.hgm.haritagenelmudurlugu.Pages.MakaleActivity;
import com.hgm.haritagenelmudurlugu.Pages.OzelSayiActivity;
import com.hgm.haritagenelmudurlugu.Pages.PdfViewActivity;
import com.hgm.haritagenelmudurlugu.Pages.StreamPDFActivity;
import com.hgm.haritagenelmudurlugu.Pages.YonetimActivity;
import com.hgm.haritagenelmudurlugu.Pages.SonSayiActivity;
...
//dashboard içerisinde 2 string değiştirilebilir
        ...
        btnsonsayi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sonsayi ="https://www.harita.gov.tr/uploads/files/mapmagazines/sonsayi.pdf";
               // mHeadingReference.setValue(sonsayi);
                Log.d("SONSAYİİİ....",sonsayi);
                Intent intent = new Intent(getActivity(), StreamPDFActivity.class);
                intent.putExtra("", sonsayi);
        ...
        btnDergiArsiv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), DergiArsivActivity.class);
                startActivity(intent);
            }
        });
        btnOzelSayi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), OzelSayiActivity.class);
                startActivity(intent);
            }
        });
        btnMakaleSorgu.setOnClickListener(v -> startActivity(new Intent(getActivity(), MakaleActivity.class)));
        ...
        btnMakaleYazimEsaslari.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String value="makale_yazim_esaslari.pdf";
        ...
        btnMakaleYazimSablonu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String value="makale_yazim_sablonu.pdf";
                Intent intent = new Intent(getActivity(), PdfViewActivity.class);
                intent.putExtra("", value);
                startActivity(intent);
            }
