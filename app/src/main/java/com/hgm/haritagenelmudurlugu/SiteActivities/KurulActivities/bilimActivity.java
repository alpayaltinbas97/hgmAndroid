...
public class bilimActivity extends AppCompatActivity {
   ...
   /*
        ...
        modelList.add(new BilimModel("Dr.Tuðg.","Osman ALP osman alp osman ","Kara Kuvvetleri","Jeodezi"));
        modelList.add(new BilimModel("Prof.Dr.","Bahadýr AKTUÐ ","Ankara Üniversitesi","Jeodezi"));
        modelList.add(new BilimModel("Prof.Dr.","Ali Melih BAÞARANER ","Yýldýz Teknik Üniversitesi","Kartografya-CBS"));
        modelList.add(new BilimModel("Prof.Dr.","Ahmet Tuðrul BAÞOKUR ","Ankara Üniversitesi","Jeofizik"));
        modelList.add(new BilimModel("general","osmanpaþa osman alp paþa ","HGM","Jeodezi"));
        modelList.add(new BilimModel("general","osman ","HGM","Jeodezi baþkanlýðý"));
