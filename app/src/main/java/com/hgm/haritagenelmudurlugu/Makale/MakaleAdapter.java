...
MakaleAdapter extends RecyclerView.Adapter<MakaleAdapter.CardTasarimTutucu> {
    ...
    public CardTasarimTutucu onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEAD) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.head_layout20000, parent, false);
    ...
    public class CardTasarimTutucu extends RecyclerView.ViewHolder {
        ...
        public CardTasarimTutucu(@NonNull View itemView, int viewType) {
            ...
            if (viewType == TYPE_LIST) {
                textViewMakale = itemView.findViewById(R.id.txtMakaleAdi);
                textViewYil = itemView.findViewById(R.id.txtSayi);
                textViewSayi = itemView.findViewById(R.id.txtDergiNo);
               // textViewYazar = itemView.findViewById(R.id.textViewYazar);
                imageViewPdf = itemView.findViewById(R.id.imgLink);
                view_type = 1;
